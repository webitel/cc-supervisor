...
import NestedObjectStoreModule from '../../../../../../../packages/client/store/BaseStoreModules/StoreModules/NestedObjectStoreModule';
...
const skills = new NestedObjectStoreModule({
	resettableItemState,
	headers,
})
