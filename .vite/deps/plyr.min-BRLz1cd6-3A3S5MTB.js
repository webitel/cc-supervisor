...
// node_modules/@webitel/ui-sdk/dist/plyr.min-BRLz1cd6.js
var import_dist = __toESM(require_dist(), 1);
var import_dist2 = __toESM(require_dist2(), 1);
var import_dist3 = __toESM(require_dist3(), 1);
function m(e, i, t) {
  return (i = pt(i)) in e ? Object.defineProperty(e, i, { value: t, enumerable: true, configurable: true, writable: true }) : e[i] = t, e;
}
function mt(e, i) {
...
function yt(e, i, t) {
  return i in e ? Object.defineProperty(e, i, { value: t, enumerable: true, configurable: true, writable: true }) : e[i] = t, e;
}
function $e(e, i) {
  var t = Object.keys(e);
...
function Oe(e) {
  for (var i = 1; i < arguments.length; i++) {
    ...
    i % 2 ? $e(Object(t), true).forEach(function(s) {
      yt(e, s, t[s]);
...
var _e = { addCSS: true, thumbWidth: 15, watch: true };
function bt(e, i) {
  return (function() {
...
function vt(e, i) {
  if (e && i) {
    var t = new Event(i, { bubbles: true });
    e.dispatchEvent(t);
  }
}
var te = function(e) {
...
var _ = { nullOrUndefined: Ve, object: Fe, number: wt, string: Ue, boolean: kt, function: Tt, array: Be, nodeList: We, element: Ct, event: At, empty: Et };
function St(e) {
...
var ie = (e) => e != null ? e.constructor : null;
var U = (e, i) => !!(e && i && e instanceof i);
var Pe = (e) => e == null;
var ze = (e) => ie(e) === Object;
var Nt = (e) => ie(e) === Number && !Number.isNaN(e);
var de = (e) => ie(e) === String;
var xt = (e) => ie(e) === Boolean;
var Ke = (e) => typeof e == "function";
var Ye = (e) => Array.isArray(e);
var Lt = (e) => U(e, WeakMap);
var Qe = (e) => U(e, NodeList);
var It = (e) => ie(e) === Text;
var $t = (e) => U(e, Event);
var Ot = (e) => U(e, KeyboardEvent);
var _t = (e) => U(e, window.TextTrackCue) || U(e, window.VTTCue);
var jt = (e) => U(e, TextTrack) || !Pe(e) && de(e.kind);
var Ht = (e) => U(e, Promise) && Ke(e.then);
var Rt = (e) => e !== null && typeof e == "object" && e.nodeType === 1 && typeof e.style == "object" && typeof e.ownerDocument == "object";
var Xe = (e) => Pe(e) || (de(e) || Ye(e) || Qe(e)) && !e.length || ze(e) && !Object.keys(e).length;
var Dt = (e) => {
  if (U(e, window.URL)) return true;
...
var qt = !!window.document.documentMode;
var Vt = /Edge/g.test(navigator.userAgent);
var Ft = "WebkitAppearance" in document.documentElement.style && !/Edge/g.test(navigator.userAgent);
var Ut = /iPhone|iPod/gi.test(navigator.userAgent) && navigator.maxTouchPoints > 1;
var Bt = navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1;
var Wt = /iPad|iPhone|iPod/gi.test(navigator.userAgent) && navigator.maxTouchPoints > 1;
...
function Ze(e, i) {
  ...
  Array.from(t).reverse().forEach((s, n) => {
    const a = n > 0 ? i.cloneNode(true) : i, l = s.parentNode, o = s.nextSibling;
...
function ge(e = null, i = false) {
  r.element(e) && e.focus({ preventScroll: true, focusVisible: i });
}
var He = { "audio/ogg": "vorbis", "audio/wav": "1", "video/webm": "vp8, vorbis", "video/mp4": "avc1.42E01E, mp4a.40.2", "video/ogg": "theora" };
var x = { audio: "canPlayType" in document.createElement("audio"), video: "canPlayType" in document.createElement("video"), check(e, i) {
  const t = x[e] || i !== "html5";
  ...
  if (r.empty(e)) return false;
  const [i] = e.split("/");
  let t = e;
  if (!this.isHTML5 || i !== this.type) return false;
...
})(), touch: "ontouchstart" in document.documentElement, transitions: ve !== false, reducedMotion: "matchMedia" in window && window.matchMedia("(prefers-reduced-motion)").matches };
var Qt = (() => {
  let e = false;
  try {
    const i = Object.defineProperty({}, "passive", { get: () => (e = true, null) });
    window.addEventListener("test", null, i), window.removeEventListener("test", null, i);
  } catch {
  }
  return e;
})();
function Z(e, i, t, s = false, n = true, a = false) {
...
function C(e, i = "", t, s = true, n = false) {
  Z.call(this, e, i, t, true, s, n);
}
function me(e, i = "", t, s = true, n = false) {
  Z.call(this, e, i, t, false, s, n);
}
function Me(e, i = "", t, s = true, n = false) {
  const a = (...l) => {
    me(e, i, a, s, n), t.apply(this, l);
  };
  Z.call(this, e, i, a, true, s, n);
}
function b(e, i = "", t = false, s = {}) {
...
var Re = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce((e, [i, t]) => ({ ...e, [i / t]: [i, t] }), {});
function it(e) {
  return r.array(e) || r.string(e) && e.includes(":") ? (r.array(e) ? e : e.split(":")).map(Number).every(r.number) : false;
}
function ue(e) {
...
var W = { getSources() {
  ...
  e.options.speed = e.config.speed.options, r.empty(this.config.ratio) || Y.call(e), Object.defineProperty(e.media, "quality", { get() {
    ...
    if (e.quality !== i) {
      ...
      b.call(e, e.media, "qualitychange", false, { quality: i });
    }
  } });
}, cancelRequests() {
...
var J = (e = "", i = "", t = "") => e.replace(new RegExp(i.toString().replace(/([.*+?^=!:${}()|[\]/\\])/g, "\\$1"), "g"), t.toString());
var nt = (e = "") => e.toString().replace(/\w\S*/g, (i) => i.charAt(0).toUpperCase() + i.slice(1).toLowerCase());
function ti(e = "") {
  let i = e.toString();
...
var ee = class _ee {
  ...
  static get supported() {
    try {
      ...
      const i = "___test";
      return window.localStorage.setItem(i, i), window.localStorage.removeItem(i), true;
    } catch {
      return false;
    }
  }
...
function se(e, i = "text") {
  return new Promise((t, s) => {
    try {
      ...
      }), n.open("GET", e, true), n.responseType = i, n.send();
    } catch (n) {
      s(n);
    }
  });
...
var rt = (e) => Math.trunc(e / 60 / 60 % 60, 10);
var ai = (e) => Math.trunc(e / 60 % 60, 10);
var ri = (e) => Math.trunc(e % 60, 10);
function pe(e = 0, i = false, t = false) {
...
var h = { getIconUrl() {
  ...
  const t = y("progress", N(q(this.config.selectors.display[e]), { min: 0, max: 100, value: 0, role: "progressbar", "aria-hidden": true }, i));
  if (e !== "volume") {
  ...
  C.call(this, e, "keydown keyup", (t) => {
    ...
    if (!s && [" ", "ArrowRight"].includes(t.key)) h.showMenuPanel.call(this, i, true);
    else {
      let n;
      t.key !== " " && (t.key === "ArrowDown" || s && t.key === "ArrowRight" ? (n = e.nextElementSibling, r.element(n) || (n = e.parentNode.firstElementChild)) : (n = e.previousElementSibling, r.element(n) || (n = e.parentNode.lastElementChild)), ge.call(this, n, true));
    }
  }, false), C.call(this, e, "keyup", (t) => {
    t.key === "Return" && h.focusFirstMenuItem.call(this, null, true);
  });
}, createMenuItem({ value: e, list: i, type: t, title: s, badge: n = null, checked: a = false }) {
  ...
  c.innerHTML = s, r.element(n) && c.appendChild(n), o.appendChild(c), Object.defineProperty(o, "checked", { enumerable: true, get: () => o.getAttribute("aria-checked") === "true", set(u) {
    ...
    if (!r.keyboardEvent(u) || u.key === " ") {
      switch (u.preventDefault(), u.stopPropagation(), o.checked = true, t) {
        case "language":
  ...
  }, t, false), h.bindMenuItemShortcuts.call(this, o, t), i.appendChild(o);
}, formatTime(e = 0, i = false) {
  return r.number(e) ? pe(e, rt(this.duration) > 0, i) : e;
}, updateTimeDisplay(e = null, i = 0, t = false) {
  ...
  if (this.touch) return void a(false);
  let l = 0;
  ...
  if (this.duration >= 2 ** 32) return z(this.elements.display.currentTime, true), void z(this.elements.progress, true);
  ...
  let n = s;
  if (r.boolean(e)) n = e;
  else if (r.keyboardEvent(e) && e.key === "Escape") n = false;
  else if (r.event(e)) {
    const a = r.function(e.composedPath) ? e.composedPath()[0] : e.target, l = i.contains(a);
    if (l || !l && e.target !== t && n) return;
  }
  t.setAttribute("aria-expanded", n), z(i, !n), S(this.elements.container, this.config.classNames.menu.open, n), n && r.keyboardEvent(e) ? h.focusFirstMenuItem.call(this, null, true) : n || s || ge.call(this, t, r.keyboardEvent(e));
}, getMenuSize(e) {
  ...
  z(n, true), z(t, false), h.focusFirstMenuItem.call(this, t, i);
}, setDownloadUrl() {
  ...
  return ke(r.array(this.config.controls) ? this.config.controls : []).forEach((f) => {
    ...
    if (f === "captions" && u.appendChild(t.call(this, "captions", g)), f === "settings" && !r.empty(this.config.settings)) {
      ...
      d.appendChild(t.call(this, "settings", { "aria-haspopup": true, "aria-controls": `plyr-settings-${e.id}`, "aria-expanded": false }));
      ...
      T.appendChild(M), k.appendChild(T), this.elements.settings.panels.home = T, this.config.settings.forEach((w) => {
        const p = y("button", N(q(this.config.selectors.buttons.settings), { type: "button", class: `${this.config.classNames.control} ${this.config.classNames.control}--forward`, role: "menuitem", "aria-haspopup": true, hidden: "" }));
        ...
        H.appendChild(y("span", { "aria-hidden": true }, $.get(w, this.config))), H.appendChild(y("span", { class: this.config.classNames.hidden }, $.get("menuBack", this.config))), C.call(this, j, "keydown", (D) => {
          D.key === "ArrowLeft" && (D.preventDefault(), D.stopPropagation(), c.call(this, "home", true));
        }, false), C.call(this, H, "click", () => {
          c.call(this, "home", false);
  ...
  if (t && r.string(this.config.controls) && (e = ((n) => {
    ...
    const n = (a) => {
      ...
      a.setAttribute("aria-pressed", "false"), Object.defineProperty(a, "pressed", { configurable: true, enumerable: true, get: () => ce(a, l), set(o = false) {
  ...
  if (O.isEdge && Je(s), this.config.tooltips.controls) {
    ...
    Array.from(o).forEach((c) => {
      S(c, this.config.classNames.hidden, false), S(c, this.config.classNames.tooltip, true);
    });
  }
}, setMediaMetadata() {
  try {
  ...
  t.forEach((c) => {
    ...
    a && (u.addEventListener("mouseenter", () => {
      c.label || (a.style.left = g, a.innerHTML = c.label, o(true));
...
var E = { setup() {
  ...
  if (r.boolean(t) || ({ active: t } = this.config.captions), Object.assign(this.captions, { toggled: false, active: t, language: i, languages: e }), this.isHTML5) {
  ...
  const e = E.getTracks.call(this, true), { active: i, language: t, meta: s, currentTrackNode: n } = this.captions, a = !!e.find((l) => l.language === t);
  ...
  if (n !== t) {
    if (i || (this.captions.active = n, this.storage.set({ captions: n })), !this.language && n && !i) {
      const a = E.getTracks.call(this), l = E.findTrack.call(this, [this.captions.language, ...this.captions.languages], true);
  ...
  if (e !== -1) if (r.number(e)) if (e in t) {
    ...
    E.toggle.call(this, true, i), this.isHTML5 && this.isVideo && E.updateCues.call(this);
  } else this.debug.warn("Track not found", e);
  else this.debug.warn("Invalid caption argument", e);
  else E.toggle.call(this, false, i);
}, setLanguage(e, i = true) {
...
var R = class _R {
  constructor(i) {
    m(this, "onChange", () => {
      ...
      b.call(this.player, s, this.active ? "enterfullscreen" : "exitfullscreen", true);
    }), m(this, "toggleFallback", (t = false) => {
      ...
      if (this.supported) {
        let t;
        t = this.forceFallback ? "Fallback (forced)" : _R.nativeSupported ? "Native" : "Fallback", this.player.debug.log(`${t} fullscreen enabled`);
      } else this.player.debug.log("Fullscreen not supported and fallback disabled");
      S(this.player.elements.container, this.player.config.classNames.fullscreen.enabled, this.supported);
    }), m(this, "enter", () => {
      this.supported && (O.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !_R.nativeSupported || this.forceFallback ? this.toggleFallback(true) : this.prefix ? r.empty(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({ navigationUI: "hide" }));
    }), m(this, "exit", () => {
      ...
      else if (!_R.nativeSupported || this.forceFallback) this.toggleFallback(false);
      else if (this.prefix) {
  ...
  get useNative() {
    return _R.nativeSupported && !this.forceFallback;
  }
  static get prefix() {
    if (r.function(document.exitFullscreen)) return "";
    let i = "";
    return ["webkit", "moz", "ms"].some((t) => !(!r.function(document[`${t}ExitFullscreen`]) && !r.function(document[`${t}CancelFullScreen`])) && (i = t, true)), i;
  }
  static get property() {
    return this.prefix === "moz" ? "FullScreen" : "Fullscreen";
  }
  get supported() {
    return [this.player.config.fullscreen.enabled, this.player.isVideo, _R.nativeSupported || this.player.config.fullscreen.fallback, !this.player.isYouTube || _R.nativeSupported || !O.isIos || this.player.config.playsinline && !this.player.config.fullscreen.iosNative].every(Boolean);
  }
  get active() {
    if (!this.supported) return false;
    if (!_R.nativeSupported || this.forceFallback) return ce(this.target, this.player.config.classNames.fullscreen.fallback);
...
var P = { addStyleHook() {
  ...
  return i && this.poster ? Promise.reject(new Error("Poster already set")) : (this.media.setAttribute("data-poster", e), this.elements.poster.removeAttribute("hidden"), Jt.call(this).then(() => re(e)).catch((t) => {
    throw e === this.poster && P.togglePoster.call(this, false), t;
  }).then(() => {
    if (e !== this.poster) throw new Error("setPoster cancelled by later call to setPoster");
  }).then(() => (Object.assign(this.elements.poster.style, { backgroundImage: `url('${e}')`, backgroundSize: "" }), P.togglePoster.call(this, true), e)));
}, checkPlaying(e) {
...
var ci = class {
  constructor(i) {
    m(this, "firstTouch", () => {
      ...
      t.touch = true, S(s.container, t.config.classNames.isTouch, true);
    }), m(this, "global", (t = true) => {
      const { player: s } = this;
      s.config.keyboard.global && Z.call(s, window, "keydown keyup", this.handleKey, t, false), Z.call(s, document.body, "click", this.toggleMenu, t), Me.call(s, document.body, "touchstart", this.firstTouch);
    }), m(this, "container", () => {
      const { player: t } = this, { config: s, elements: n, timers: a } = t;
      !s.keyboard.global && s.keyboard.focused && C.call(t, n.container, "keydown keyup", this.handleKey, false), C.call(t, n.container, "mousemove mouseleave touchstart touchmove enterfullscreen exitfullscreen", (c) => {
        const { controls: u } = n;
        u && c.type === "enterfullscreen" && (u.pressed = false, u.hover = false);
        let g = 0;
        ["touchstart", "touchmove", "mousemove"].includes(c.type) && (P.toggleControls.call(t, true), g = t.touch ? 3e3 : 2e3), clearTimeout(a.controls), a.controls = setTimeout(() => P.toggleControls.call(t, false), g);
      });
      const l = () => {
      ...
      t.supported.ui && t.config.disableContextMenu && C.call(t, s.wrapper, "contextmenu", (a) => {
        a.preventDefault();
      }, false), C.call(t, t.media, "volumechange", () => {
      ...
      C.call(t, t.media, n, (a) => {
        let { detail: l = {} } = a;
        a.type === "error" && (l = t.media.error), b.call(t, s.container, a.type, true, l);
      });
    }), m(this, "proxy", (t, s, n) => {
      const { player: a } = this, l = a.config.listeners[n];
      let o = true;
      r.function(l) && (o = l.call(a, t)), o !== false && r.function(s) && s.call(a, t);
    }), m(this, "bind", (t, s, n, a, l = true) => {
      ...
      }, null, false), this.bind(s.buttons.settings, "keyup", (a) => {
        [" ", "Enter"].includes(a.key) && (a.key !== "Enter" ? (a.preventDefault(), a.stopPropagation(), h.toggleMenu.call(t, a)) : h.focusFirstMenuItem.call(t, null, true));
      }, null, false), this.bind(s.settings.menu, "keydown", (a) => {
      ...
      this.bind(s.inputs.seek, n, (a) => {
        ...
        a && a.loaded && a.endMove(false, true);
        ...
        S(s.controls, a.classNames.noTransition, true), P.toggleControls.call(t, true), setTimeout(() => {
          S(s.controls, a.classNames.noTransition, false);
        }, 0);
        const o = this.touch ? 3e3 : 4e3;
        clearTimeout(l.controls), l.controls = setTimeout(() => P.toggleControls.call(t, false), o);
...
var hi = ui(function(e, i) {
  e.exports = function() {
    ...
    function u(d, v, k, T) {
      ...
      }, j(d, w) !== false && p.head.appendChild(w);
    }
    function g(d, v, k) {
...
function Q(e) {
  e && !this.embed.hasPlayed && (this.embed.hasPlayed = true), this.media.paused === e && (this.media.paused = !e, b.call(this, this.media, e ? "play" : "pause"));
}
var Ce = { setup() {
  const e = this;
  S(e.elements.wrapper, e.config.classNames.embed, true), e.options.speed = e.config.speed.options, Y.call(e), r.object(window.Vimeo) ? Ce.ready.call(e) : xe(e.config.urls.vimeo.sdk).then(() => {
    Ce.ready.call(e);
  }).catch((i) => {
  ...
  const o = l ? { h: l } : {};
  t && Object.assign(n, { controls: false, sidedock: false });
  ...
  }), e.embed = new window.Vimeo.Player(g, { autopause: e.config.autopause, muted: e.muted }), e.media.paused = true, e.media.currentTime = 0, e.supported.ui && e.embed.disableTextTrack(), e.media.play = () => (Q.call(e, true), e.embed.play()), e.media.pause = () => (Q.call(e, false), e.embed.pause()), e.media.stop = () => {
  ...
  Object.defineProperty(e.media, "currentTime", { get: () => d, set(p) {
    ...
    L.seeking = true, b.call(e, L, "seeking"), Promise.resolve(D && A.setVolume(0)).then(() => A.setCurrentTime(p)).then(() => D && A.pause()).then(() => D && A.setVolume(H)).catch(() => {
    });
  } });
  ...
  Object.defineProperty(e.media, "loop", { get: () => w, set(p) {
    ...
    Q.call(e, true), b.call(e, e.media, "playing");
  }), e.embed.on("pause", () => {
    Q.call(e, false);
  }), e.embed.on("timeupdate", (p) => {
    e.media.seeking = false, d = p.seconds, b.call(e, e.media, "timeupdate");
    ...
    e.media.seeking = false, b.call(e, e.media, "seeked");
  }), e.embed.on("ended", () => {
    e.media.paused = true, b.call(e, e.media, "ended");
  }), e.embed.on("error", (p) => {
...
var le = { setup() {
  if (S(this.elements.wrapper, this.config.classNames.embed, true), r.object(window.YT) && r.function(window.YT.Player)) le.ready.call(this);
  else {
  ...
  e.embed = new window.YT.Player(e.media, { videoId: n, host: gi(i), playerVars: N({}, { autoplay: e.config.autoplay ? 1 : 0, hl: e.config.hl, controls: e.supported.ui && i.customControls ? 0 : 1, disablekb: 1, playsinline: e.config.playsinline && !e.config.fullscreen.iosNative ? 1 : 0, cc_load_policy: e.captions.active ? 1 : 0, cc_lang_pref: e.config.captions.language, widget_referrer: window ? window.location.href : null }, i), events: { onError(l) {
    ...
    le.getTitle.call(e, n), e.media.play = () => {
      X.call(e, true), o.playVideo();
    }, e.media.pause = () => {
      X.call(e, false), o.pauseVideo();
    }, e.media.stop = () => {
      o.stopVideo();
    }, e.media.duration = o.getDuration(), e.media.paused = true, e.media.currentTime = 0, Object.defineProperty(e.media, "currentTime", { get: () => Number(o.getCurrentTime()), set(f) {
      e.paused && !e.embed.hasPlayed && e.embed.mute(), e.media.seeking = true, b.call(e, e.media, "seeking"), o.seekTo(f);
    ...
    const o = l.target;
    switch (clearInterval(e.timers.playing), e.media.seeking && [1, 2].includes(l.data) && (e.media.seeking = false, b.call(e, e.media, "seeked")), l.data) {
      case -1:
        b.call(e, e.media, "timeupdate"), e.media.buffered = o.getVideoLoadedFraction(), b.call(e, e.media, "progress");
        break;
      case 0:
        X.call(e, false), e.media.loop ? (o.stopVideo(), o.playVideo()) : b.call(e, e.media, "ended");
        break;
      case 1:
        i.customControls && !e.config.autoplay && e.media.paused && !e.embed.hasPlayed ? e.media.pause() : (X.call(e, true), b.call(e, e.media, "playing"), e.timers.playing = setInterval(() => {
        ...
        break;
      case 2:
        e.muted || e.embed.unMute(), X.call(e, false);
        break;
      case 3:
        b.call(e, e.media, "waiting");
    }
    b.call(e, e.elements.container, "statechange", false, { code: l.data });
  } } });
} };
var ut = { setup() {
  this.media ? (S(this.elements.container, this.config.classNames.type.replace("{0}", this.type), true), S(this.elements.container, this.config.classNames.provider.replace("{0}", this.provider), true), this.isEmbed && S(this.elements.container, this.config.classNames.type.replace("{0}", "video"), true), this.isVideo && (this.elements.wrapper = y("div", { class: this.config.classNames.video }), Ze(this.media, this.elements.wrapper), this.elements.poster = y("div", { class: this.config.classNames.poster }), this.elements.wrapper.appendChild(this.elements.poster)), this.isHTML5 ? W.setup.call(this) : this.isYouTube ? le.setup.call(this) : this.isVimeo && Ce.setup.call(this)) : this.debug.warn("No media element found!");
} };
var fi = class {
  constructor(i) {
    m(this, "load", () => {
      ...
      try {
        ...
        s.adTagUrl = this.tagUrl, s.linearAdSlotWidth = t.offsetWidth, s.linearAdSlotHeight = t.offsetHeight, s.nonLinearAdSlotWidth = t.offsetWidth, s.nonLinearAdSlotHeight = t.offsetHeight, s.forceNonLinearFullSlot = false, s.setAdWillPlayMuted(!this.player.muted), this.loader.requestAds(s);
      } catch (s) {
        this.onAdError(s);
      }
    }), m(this, "pollCountdown", (t = false) => {
      ...
      s.restoreCustomPlaybackStateOnAdBreakComplete = true, s.enablePreloading = true, this.manager = t.getAdsManager(this.player, s), this.cuePoints = this.manager.getCuePoints(), this.manager.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, (n) => this.onAdError(n)), Object.keys(google.ima.AdEvent.Type).forEach((n) => {
      ...
      switch (((l) => {
        ...
        case google.ima.AdEvent.Type.LOADED:
          this.trigger("loaded"), this.pollCountdown(true), n.isLinear() || (n.width = s.offsetWidth, n.height = s.offsetHeight);
          break;
      ...
      this.managerPromise || this.resumeContent(), this.managerPromise.then(() => {
        ...
        try {
          this.initialized || (this.manager.init(t.offsetWidth, t.offsetHeight, google.ima.ViewMode.NORMAL), this.manager.start()), this.initialized = true;
        } catch (s) {
          this.onAdError(s);
        }
      }).catch(() => {
      ...
      this.elements.container.style.zIndex = "", this.playing = false, V(this.player.media.play());
    }), m(this, "pauseContent", () => {
    ...
    }), this.player = i, this.config = i.config.ads, this.playing = false, this.initialized = false, this.elements = { container: null, displayContainer: null }, this.manager = null, this.loader = null, this.cuePoints = null, this.events = {}, this.safetyTimer = null, this.countdownTimer = null, this.managerPromise = new Promise((t, s) => {
...
var Ae = class {
  constructor(i) {
    m(this, "load", () => {
      ...
      (r.nullOrUndefined(t.button) || t.button === false || t.button === 0) && (this.mouseDown = true, this.player.media.duration && (this.toggleScrubbingContainer(true), this.toggleThumbContainer(false, true), this.showImageAtCurrentTime()));
    }), m(this, "endScrubbing", () => {
      this.mouseDown = false, Math.ceil(this.lastTime) === Math.ceil(this.player.media.currentTime) ? this.toggleScrubbingContainer(false) : Me.call(this.player, this.player.media, "timeupdate", () => {
      ...
      if (this.currentImageElement && this.currentImageElement.dataset.filename === o) this.showImage(this.currentImageElement, l, t, s, o, false), this.currentImageElement.dataset.index = s, this.removeOldImages(this.currentImageElement);
      else {
        this.loadingImage && this.usingSprites && (this.loadingImage.onload = null);
        const u = new Image();
        u.src = c, u.dataset.index = s, u.dataset.filename = o, this.showingThumbFilename = o, this.player.debug.log(`Loading image: ${c}`), u.onload = () => this.showImage(u, l, t, s, o, true), this.loadingImage = u, this.removeOldImages(u);
      }
    }), m(this, "showImage", (t, s, n, a, l, o = true) => {
      this.player.debug.log(`Showing thumb: ${l}. num: ${a}. qual: ${n}. newimg: ${o}`), this.setImageSizeAndOffset(t, s), o && (this.currentImageContainer.appendChild(t), this.currentImageElement = t, this.loadedImages.includes(l) || this.loadedImages.push(l)), this.preloadNearby(a, true).then(this.preloadNearby(a, false)).then(this.getHigherQuality(n, t, s, l));
    ...
    }), m(this, "preloadNearby", (t, s = true) => new Promise((n) => {
      setTimeout(() => {
        ...
        if (this.showingThumbFilename === a) {
          ...
          l.forEach((c) => {
            ...
            if (u !== a && !this.loadedImages.includes(u)) {
              o = true, this.player.debug.log(`Preloading thumb filename: ${u}`);
    ...
    }), m(this, "toggleThumbContainer", (t = false, s = false) => {
    ...
    }), m(this, "toggleScrubbingContainer", (t = false) => {
    ...
    }), this.player = i, this.thumbnails = [], this.loaded = false, this.lastMouseMoveTime = Date.now(), this.mouseDown = false, this.loadedImages = [], this.elements = { thumb: {}, scrubbing: {} }, this.load();
  }
  get enabled() {
...
var he = class _he {
  constructor(i, t) {
    if (m(this, "play", () => r.function(this.media.play) ? (this.ads && this.ads.enabled && this.ads.managerPromise.then(() => this.ads.play()).catch(() => V(this.media.play())), this.media.play()) : null), m(this, "pause", () => this.playing && r.function(this.media.pause) ? this.media.pause() : null), m(this, "togglePlay", (o) => (r.boolean(o) ? o : !this.playing) ? this.play() : this.pause()), m(this, "stop", () => {
      ...
      if (this.supported.ui && !this.isAudio) {
        ...
        if (g && r.array(this.config.controls) && this.config.controls.includes("settings") && !r.empty(this.config.settings) && h.toggleMenu.call(this, false), g !== c) {
    ...
    }), m(this, "destroy", (o, c = false) => {
      if (!this.ready) return;
      const u = () => {
        document.body.style.overflow = "", this.embed = null, c ? (Object.keys(this.elements).length && (F(this.elements.buttons.play), F(this.elements.captions), F(this.elements.controls), F(this.elements.wrapper), this.elements.buttons.play = null, this.elements.captions = null, this.elements.controls = null, this.elements.wrapper = null), r.function(o) && o()) : (Xt.call(this), W.cancelRequests.call(this), oe(this.elements.original, this.elements.container), b.call(this, this.elements.original, "destroyed", true), r.function(o) && o.call(this.elements.original), this.ready = false, setTimeout(() => {
          this.elements = null, this.media = null;
        }, 200));
      };
      this.stop(), clearTimeout(this.timers.loading), clearTimeout(this.timers.controls), clearTimeout(this.timers.resized), this.isHTML5 ? (P.toggleNativeControls.call(this, true), u()) : this.isYouTube ? (clearInterval(this.timers.buffering), clearInterval(this.timers.playing), this.embed !== null && r.function(this.embed.destroy) && this.embed.destroy(), u()) : this.isVimeo && (this.embed !== null && this.embed.unload().then(u), setTimeout(u, 200));
    }), m(this, "supports", (o) => x.mime.call(this, o)), this.timers = {}, this.ready = false, this.loading = false, this.failed = false, this.touch = x.touch, this.media = i, r.string(this.media) && (this.media = document.querySelectorAll(this.media)), (window.jQuery && this.media instanceof jQuery || r.nodeList(this.media) || r.array(this.media)) && (this.media = this.media[0]), this.config = N({}, ct, _he.defaults, t || {}, (() => {
      try {
    ...
    const s = this.media.cloneNode(true);
    ...
    switch (n) {
      case "div":
        if (a = this.media.querySelector("iframe"), r.element(a)) {
          if (l = lt(a.getAttribute("src")), this.provider = li(l.toString()), this.elements.container = this.media, this.media = a, this.elements.container.className = "", l.search.length) {
            const o = ["1", "true"];
            o.includes(l.searchParams.get("autoplay")) && (this.config.autoplay = true), o.includes(l.searchParams.get("loop")) && (this.config.loop.active = true), this.isYouTube ? (this.config.playsinline = o.includes(l.searchParams.get("playsinline")), this.config.youtube.hl = l.searchParams.get("hl")) : this.config.playsinline = true;
          }
      ...
      case "video":
      case "audio":
        this.type = n, this.provider = B.html5, this.media.hasAttribute("crossorigin") && (this.config.crossorigin = true), this.media.hasAttribute("autoplay") && (this.config.autoplay = true), (this.media.hasAttribute("playsinline") || this.media.hasAttribute("webkit-playsinline")) && (this.config.playsinline = true), this.media.hasAttribute("muted") && (this.config.muted = true), this.media.hasAttribute("loop") && (this.config.loop.active = true);
        break;
      default:
  ...
  set volume(i) {
    let t = i;
    r.string(t) && (t = Number(t)), r.number(t) || (t = this.storage.get("volume")), r.number(t) || ({ volume: t } = this.config), t > 1 && (t = 1), t < 0 && (t = 0), this.config.volume = t, this.media.volume = t, !r.empty(i) && this.muted && t > 0 && (this.muted = false);
  }
  get volume() {
  ...
  set quality(i) {
    ...
    if (!s.length) return;
    let n = [!r.empty(i) && Number(i), this.storage.get("quality"), t.selected, t.default].find(r.number), a = true;
    if (!s.includes(n)) {
      const l = et(s, n);
      this.debug.warn(`Unsupported quality option: ${n}, using ${l} instead`), n = l, a = false;
    }
  ...
  set poster(i) {
    this.isVideo ? P.setPoster.call(this, i, false).catch(() => {
  ...
  toggleCaptions(i) {
    E.toggle.call(this, i, false);
  }
  set currentTrack(i) {
    E.set.call(this, i, false), E.setup.call(this);
  }
  get currentTrack() {
  ...
  set language(i) {
    E.setLanguage.call(this, i, false);
  }
  get language() {
  ...
  static setup(i, t = {}) {
    let s = null;
    return r.string(i) ? s = Array.from(document.querySelectorAll(i)) : r.nodeList(i) ? s = Array.from(i) : r.array(i) && (s = i.filter(r.element)), r.empty(s) ? null : s.map((n) => new _he(n, t));
  }
};
he.defaults = zt(ct);
export {
...
//# sourceMappingURL=plyr.min-BRLz1cd6-3A3S5MTB.js.map
