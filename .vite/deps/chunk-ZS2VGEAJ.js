...
var require_lib = __commonJS({
  "node_modules/csv-stringify/lib/index.js"(exports, module) {
    var import_dist4 = __toESM(require_dist());
    var import_dist5 = __toESM(require_dist2());
    var import_dist6 = __toESM(require_dist3());
    var { Transform } = require_stream_browserify();
    var bom_utf8 = Buffer.from([239, 187, 191]);
    var Stringifier = class extends Transform {
      constructor(opts = {}) {
      ...
      _transform(chunk, encoding, callback) {
        ...
        if (this.info.records === 0) {
          ...
          } else if (this.options.columns === void 0 || this.options.columns === null) {
      ...
      normalize_columns(columns) {
        ...
        if (!Array.isArray(columns)) {
          ...
          for (let column of columns) {
            ...
            } else if (typeof column === "object" && column !== void 0 && !Array.isArray(column)) {
              if (!column.key) {
    ...
    stringify2.Stringifier = Stringifier;
    stringify2.CsvError = CsvError;
    ...
    var getTag = function(value) {
      if (!value)
        value === void 0 ? "[object Undefined]" : "[object Null]";
...
var require_sync = __commonJS({
  "node_modules/csv-stringify/lib/sync.js"(exports, module) {
    var import_dist4 = __toESM(require_dist());
    var import_dist5 = __toESM(require_dist2());
    var import_dist6 = __toESM(require_dist3());
    var stringify2 = require_lib();
    ...
    module.exports = function(records, options = {}) {
      ...
      let stringifier = new stringify2.Stringifier(options);
...
// node_modules/@webitel/ui-sdk/src/modules/CSVExport/CSVExport.js
  ...
  object: (separator) => {
    const cast2 = (object) => {
      if (Array.isArray(object)) {
        return object.map((item) => cast2(item)).join(separator);
      }
...
var CSVExport = class _CSVExport {
  constructor(fetchMethod, { filename, delimiter }) {
    __publicField(this, "filename", "export");
    __publicField(this, "fetchMethod", null);
    __publicField(this, "downloadProgress", { count: 0 });
  ...
  async stringify(params = {}) {
    let csv = "";
    let isNext = false;
    let columns = params._columns || ((params == null ? void 0 : params.fields) ? objSnakeToCamel(params == null ? void 0 : params.fields) : []);
    let page = 1;
    do {
      ...
      const options = {
        ..._CSVExport._getStringifyOptions(params.delimiter),
        columns
      };
      csv += (0, import_sync.default)(items, options);
...
//# sourceMappingURL=chunk-ZS2VGEAJ.js.map
