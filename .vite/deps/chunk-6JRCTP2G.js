...
function createCoreError(code) {
  return createCompileError(code, null, process.env.NODE_ENV !== "production" ? { messages: errorMessages2 } : void 0);
}
var errorMessages2 = {
...
function translate(context, ...args) {
  ...
  if (process.env.NODE_ENV !== "production" && isString(format3) && context.messageCompiler == null) {
...
function createI18nError(code, ...args) {
  return createCompileError(code, null, process.env.NODE_ENV !== "production" ? { messages: errorMessages3, args } : void 0);
}
var errorMessages3 = {
...
vue-i18n/dist/vue-i18n.mjs:
  (*!
    ...
    *)
*/
//# sourceMappingURL=chunk-6JRCTP2G.js.map
